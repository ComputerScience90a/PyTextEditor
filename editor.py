...
def about():
	...
	source=Label(about,text="Get Source from:https://source.com",font=("arial",12),bg="#262626",fg="#fff");
...
text=Text(root,width="1300",height="600",font='arial',yscrollcommand=scrollbar.set)
text.place(x="0",y="0")
